...
export function MessagesClient({ conversations, initialMessages, selectedSenderId, userId }: Props) {
  ...
  async function sendReply() {
    ...
    try {
      const res = await serverFetch("/api/messages/send", userId, {
        method: "POST",
  ...
  async function suggestAI() {
    ...
    setGenerating(true);
    try {
      const res = await serverFetch("/api/ai/suggest-reply", userId, {
        method: "POST",
