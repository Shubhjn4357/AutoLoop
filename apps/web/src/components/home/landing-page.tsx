      ...
      <header className="sticky top-0 z-40 border-b border-border/50 bg-background/60 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:px-6">
          <Link href="/" className="flex items-center gap-2 group">
            <span className="flex size-9 items-center justify-center rounded-xl bg-linear-to-br from-primary to-purple-600 text-white shadow-lg transition-transform group-hover:scale-105">
          ...
          <div className="mx-auto grid max-w-7xl gap-12 px-4 md:px-6 lg:grid-cols-[minmax(0,1fr)_minmax(380px,0.8fr)] items-center">
            ...
            >
              ...
              <motion.h1 variants={itemVariants} className="max-w-3xl text-5xl font-extrabold tracking-tight leading-[1.1] sm:text-6xl lg:text-7xl">
                Automate Instagram <span className="text-transparent bg-clip-text bg-linear-to-r from-primary to-fuchsia-500">DMs like a Pro.</span>
              </motion.h1>
            ...
            >
              <div className="absolute inset-0 bg-linear-to-tr from-primary/20 to-fuchsia-500/20 blur-3xl -z-10 rounded-[3rem]" />
              <div className="glass-card rounded-3xl p-6 glow-ring overflow-hidden">
                ...
                <div className="space-y-3 relative">
                  <div className="absolute left-[1.15rem] top-8 bottom-8 w-[2px] bg-linear-to-b from-blue-500/50 via-emerald-500/50 to-rose-500/50 -z-10" />
